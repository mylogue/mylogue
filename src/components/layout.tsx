...
export default function Layout() {
  const user = auth.currentUser; // This can be null
  ...
  const handleItemClick = (index: number) => {
    ...
    toggleSideMenu(); // Close the side menu on item click
  };
        ...
        <Container>
          <SideMenu isOpen={isSideMenuOpen}>
            <Link to="/" style={{ textDecoration: "none" }}>
              ...
              >
                <ItemName style={{ color: "#0085FF", padding: "0px", fontSize: "1.5rem" }}>
                  Mylogue
                </ItemName>
              </MenuItem>
            </Link>
          ...
          {user && ( // Check if user exists before rendering profile link
            <SideMenu isOpen={isSideMenuOpen}>
          ...
          <Link to="/modal" className="modal" style={{ textDecoration: "none" }}>
